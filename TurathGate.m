...
// رابط الحصول على الرمز (اترك الرابط فارغاً إذا لم ترغب به)
...
- (void)setupUI {
    ...
    // استخدام تعويض مباشر لـ CGSize لتجنب الاستدعاء الخارجي لـ CGSizeZero المسبب للخطأ
...
// آلية حقن متوافقة كلياً وبدون تحذيرات لتجاوز مشاكل الأجهزة والنسخ القديمة والحديثة
...
2. اضغط على أيقونة **القلم** لتعديل الملف، ثم احذف الكود القديم بالكامل والصق الكود الجديد الموجود بالأعلى.
3. احفظ التغييرات (Commit changes).
4. ارجع إلى موقع **Codemagic** واضغط على **Start new build**؛ ستلاحظ أن البناء يكتمل بنجاح دون أي أخطاء أو تحذيرات وستحصل على ملف الـ `dylib` المطلوب مباشرة!
