...
// ══════════════════════════════════════════════
//  تخطيط أفقي (Landscape) — الشخصية يسار، كونترولات يمين
// ══════════════════════════════════════════════
- (void)buildLandscape:(CGFloat)W height:(CGFloat)H {
    CGFloat leftW  = W * 0.44;   // عرض قسم الشخصية
    CGFloat rightX = leftW;
    CGFloat rightW = W - leftW;  // عرض قسم الكونترولات
    CGFloat pad    = 20;
    ...
    glow.backgroundColor = [[UIColor colorWithRed:.15 green:.4 blue:1 alpha:.12] colorWithAlphaComponent:.12];
    glow.layer.shadowColor = [UIColor colorWithRed:.2 green:.5 blue:1 alpha:1].CGColor;
    glow.layer.shadowRadius = 35;
    glow.layer.shadowOpacity = .6;
    ...
    star.text = @"★";
    star.font = [UIFont systemFontOfSize:logoSize * .55];
    ...
    star.layer.shadowRadius = 10;
    star.layer.shadowOpacity = .9;
    ...
    ry += sub.bounds.size.height + H * .04;
    ...
    ok.layer.shadowRadius = 12;
    ok.layer.shadowOpacity = .6;
...
// ══════════════════════════════════════════════
//  تخطيط عمودي (Portrait) — الاحتياطي
// ══════════════════════════════════════════════
- (void)buildPortrait:(CGFloat)W height:(CGFloat)H {
    ...
    [self outBtn:CGRectMake(rx,y,fw,50) title:@"   🔗  ثانيا - ادخل هنا للحصول على رمز الدخول"
